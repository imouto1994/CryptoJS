...
const { getMarketTickers } = require("../src/yobit/ApiPublic");
const {
  getAccountInfo,
  makeTradeOrder,
  cancelOrder,
  getOrderInfo,
} = require("../src/yobit/ApiTrade");
const {
  CURRENCY_BITCOIN,
  CURRENCY_PRECISION,
...
//     chunkSourceAmount / (1 + YOBIT_COMMISSION_RATE),
//     CURRENCY_PRECISION,
//   );
//   logInfo(
...
async function runBot() {
  ...
  const accountInfo = await getAccountInfo(sourceCurrency);
