...
from telethon.tl.types import UpdateShortChatMessage, UpdateShortMessage, UpdateNewChannelMessage
...
class InteractiveTelegramClient(TelegramClient):
    ...
    def update_handler(update_object):
        ...
        #         print('\n\nNew Message\n')
        #         print(update_object.updates[0].message.message)
        #         print('\n\n-----------\n\n')
...
client = InteractiveTelegramClient('session_id', user_phone, api_id, api_hash)
client.getConfig()
